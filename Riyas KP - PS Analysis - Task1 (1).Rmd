...
I have created this markdown in R language inside RStudio. I have used ggplot to create different types of plots and visualization, i found it simple and efficient using ggplot rather than the defualt R syntax.

Since i have been learnig R for sometime, this is very first interaction with a live project.
